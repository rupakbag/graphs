...
public class WeightedGraphTest {
    ...
    public void addEdge() throws Exception {
        ...
        assertEquals("[n1, n2]", g.v.toString());
        assertEquals("[n2(2)]", g.getAdjEdgeList(n1).toString());
        assertEquals(null, g.getAdjEdgeList(n2));
        ...
        assertEquals("[n2(2)]", g.getAdjEdgeList(n1).toString());
        assertEquals("[n2(5)]", g.getAdjEdgeList(n3).toString());
        assertEquals(null, g.getAdjEdgeList(n2));
        ...
        assertEquals("[n1, n2, n3]", g.v.toString());
        assertEquals("[n2(2)]", g.getAdjEdgeList(n1).toString());
        assertEquals("[n2(5), n1(1)]", g.getAdjEdgeList(n3).toString());
        assertEquals(null, g.getAdjEdgeList(n2));
        assertEquals(2, n2.incomingEdgeCount);
    ...
    public void removeEdge() throws Exception {
        ...
        assertEquals("[n1, n2, n3]", g.v.toString());
        assertEquals("[n2(2)]", g.getAdjEdgeList(n1).toString());
        assertEquals("[n1(1)]", g.getAdjEdgeList(n3).toString());
        assertEquals(null, g.getAdjEdgeList(n2));
        assertEquals(1, n2.incomingEdgeCount);
        assertEquals(1, n1.incomingEdgeCount);
        assertEquals(0, n3.incomingEdgeCount);
        ...
        assertEquals("[n1, n2, n3]", g.v.toString());
        assertEquals(null, g.getAdjEdgeList(n1));
        assertEquals(null, g.getAdjEdgeList(n2));
        assertEquals("[n1(1)]", g.getAdjEdgeList(n3).toString());
        assertEquals(0, n2.incomingEdgeCount);
        assertEquals(1, n1.incomingEdgeCount);
    ...
    public void removeNode() throws Exception {
        ...
        assertEquals("[n1, n2, n3]", g.v.toString());
        assertEquals("[n2(3)]", g.getAdjEdgeList(n1).toString());
        assertEquals("[n2(5), n1(1)]", g.getAdjEdgeList(n3).toString());
        assertEquals(null, g.getAdjEdgeList(n2));
        assertEquals(2, n2.incomingEdgeCount);
        assertEquals(1, n1.incomingEdgeCount);
